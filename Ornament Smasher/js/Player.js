 ...
 */
var health = 3;
Player = function(game, target, spawnPoint) {

    if (!spawnPoint) {
        spawnPoint = new BABYLON.Vector3(0,25,-10);
    }
    ...
    this.actionManager = new BABYLON.ActionManager(this.game.scene);
